...
class MeetupDetails extends Component {
    ...
    onDelete() {
        ...
        axios.delete(`${process.env.NODE_ENV === 'development' ? 'https://test-environment-dillonmabry.c9users.io' : ""}/api/meetups/${meetupId}`)
        .then(response => {
    ...
    render() {
        return (
          <div>
            ...
            <Link className="btn blue" to={`/meetups/edit/${this.state.details.id}`}>Edit</Link>
